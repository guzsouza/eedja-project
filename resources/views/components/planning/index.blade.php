<x-app-layout>
    ...
    <section class="section-container">
        <div class="card-container d-flex">
            <button type="button" class="btn bg-primary" onclick="changeStep('1')">Busca Simples</button>
    ...
    <script>
        ...
        function showInputTeacher(input){
            if(input === "teacher"){
                if(document.getElementById('teacherCheck').checked){
                    $("#teachers").fadeIn(350);
                } else{
                    $("#teachers").fadeOut(350);
                }
            }
        }

        function showInputDiscipline(input){
            if(input === "discipline"){
                if(document.getElementById('disciplineCheck').checked){
                    $("#disciplines").fadeIn(350);
                } else{
                    $("#disciplines").fadeOut(350);
                }
            }
        }
